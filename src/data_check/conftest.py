...
def data(request):
    ...
    data_path = run.use_artifact("lbekel-western-governors-university/nyc_airbnb/clean_sample:latest").file()
...
def ref_data(request):
    ...
    data_path = run.use_artifact("lbekel-western-governors-university/nyc_airbnb/clean_sample:reference").file()
