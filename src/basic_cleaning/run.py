...
def go(args):
    ...
    idx = df['longitude'].between(-74.25, -73.50) & df['latitude'].between(40.5, 41.2) #added to clean data per instructions
    df = df[idx].copy() #added to clean data per instructions
